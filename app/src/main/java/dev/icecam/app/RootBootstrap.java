...
public final class RootBootstrap {
    ...
    public String bootstrap() {
        ...
        String script = "set -x\n" +
                ...
                "cp -f $SRC/libshadowhook_nothing.so /data/camera/libshadowhook_nothing.so 2>/dev/null || true\n" +
                "cp -f $SRC/libshadowhook_nothing.so /data/libshadowhook_nothing.so 2>/dev/null || true\n" +
                ...
                "chmod 644 /data/libvc.so /data/libvc++.so /data/camera/libvc.so /data/camera/libshadowhook.so /data/camera/libshadowhook_nothing.so 2>/dev/null || true\n" +
